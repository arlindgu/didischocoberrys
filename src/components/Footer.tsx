...
<footer className='flex flex-col justify-center items-center mt-8 mb-4'>
            <ul className="flex flex-wrap items-center mb-4 text-sm font-medium text-brand-700">
                ...
                <li>
                    <a href="https://instagram.com/didischocoberrys" className=" me-4 md:me-6">Instagram</a>
                </li>
            </ul>
        <span className="block text-sm text-brand-700">© 2025 <a>DidisChocoBerrys</a>. All Rights Reserved.</span>
</footer>
